...
const ReturnCar_service_1 = require("./ReturnCar.service");
const ReturnCar = (0, catchAsync_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield ReturnCar_service_1.ReturnCarService.ReturnCarIntoDB(req.body);
}));
exports.ReturnCarController = {
    ReturnCar
};
